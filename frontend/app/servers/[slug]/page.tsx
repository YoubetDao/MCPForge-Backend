...
import { getMCPCards, startMCPServer, checkMCPServerStatus, pollServerStatus, deleteMCPServer } from "@/lib/api"
  ...
  const handleServerAction = async () => {
    if (isServerRunning) {
      try {
        ...
        setServerStartError(error instanceof Error ? error.message : "Failed to stop MCP server");
      } finally {
        setIsDeleting(false);
      }
      return;
